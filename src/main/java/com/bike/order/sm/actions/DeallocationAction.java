...
public class DeallocationAction implements Action<BikeOrderStatusEnum, BikeOrderEventEnum> {
    ...
    public void execute(StateContext<BikeOrderStatusEnum, BikeOrderEventEnum> stateContext) {
        ...
        log.debug("Sent deallocate request to queue for order id " + bikeOrder.getId());
    }
}
